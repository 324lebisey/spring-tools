...
export default function PetCareKR(){const[pt,sP]=useState("");const[ds,sDS]=useState("");const[ct,sCT]=useState("");const[petRegion,sPR]=useState("");const[con,sCon]=useState([]);const[plan,sPl]=useState(false);const[ch,sCh]=useState({});const[exp,sExp]=useState("vet");const ref=useRef(null);
